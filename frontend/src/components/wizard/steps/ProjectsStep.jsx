...
import SingleDatePicker from "../../ui/SingleDatePicker.jsx";
    ...
    <RepeatableSection
      ...
      renderItem={(item, update) => (
        <div className={styles.stack}>
          ...
          <div>
            <p className={styles.sectionLabel} style={{ marginBottom: "0.4rem" }}>{p.date}</p>
            <SingleDatePicker value={item.date} onChange={(v) => update({ ...item, date: v })} />
          </div>
